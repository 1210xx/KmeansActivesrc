...
public class RJ_CAKU004 {
	 ...
	 **************************************
	 */
	public RJ_CAKU004(String paraFilename, double[] paraMisclassificationCost, double paraTeachCost) {
		data = null;
		try {
	...
	public void querySplitClassify(int[] paraBlock, int paraInitialPoint) {
		...
		if (tempQueried.length > 1) {
			System.out.println("++++++++++++(querySplitClassify) I get in quied array");
	...
	public static void testTotalCost() {
		...
		double[] tempMisclassificationCost = { 2, 4 };
		double tempTeachCost = 1;
		RJ_CAKU004 caku = new RJ_CAKU004("src/data/rj4instancetest.arff", tempMisclassificationCost, tempTeachCost);
	...
	public static void testIndexToInstance() {
		...
		double[] tempMisclassificationCost = { 2, 4 };
		double tempTeachCost = 1;
		RJ_CAKU004 caku = new RJ_CAKU004("data/rj4instancetest.arff", tempMisclassificationCost, tempTeachCost);
